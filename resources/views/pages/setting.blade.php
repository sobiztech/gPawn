                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">Key Name</th>
                                    <th class="wd-15p border-bottom-0">Key Value</th>
                                ...
                                @foreach ($settings as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            data-id="{{ $row->id }}"
                                            data-key_name="{{ $row->key_name }}" 
                                            data-key_value="{{ $row->key_value }}" 
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createFormModal">Create Setting</h5>
                ...
                <div class="modal-body">
                    ...
                    <form  method="POST" action="{{ route('setting.store') }}">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="key_name" name="key_name"
                                            placeholder="Enter the  Key Name" value="{{ old('key_name') }}" required/>
                                        <p style="color:Tomato"> @error('key_name'){{ $message }} @enderror</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Key Value<span class="text-danger">*</span></label>
                                    <div>
                                        <input type="text" class="form-control" id="key_value" name="key_value"
                                            placeholder="Enter the  Key Value" value="{{ old('key_value') }}" required/>
                                        <p style="color:Tomato"> @error('key_value'){{ $message }} @enderror</p>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        if (!@json($errors->isEmpty())) {
            ...
            if (id == 0) {
                $('#createFormModal').html('Create Setting');
            } else {
                $('#createFormModal').html('Update Setting');
            }
        }
        ...
        $('.edit').click(function () { 
            ...
            $("#key_name").val($(this).attr('data-key_name'));
            $("#key_value").val($(this).attr('data-key_value'));
