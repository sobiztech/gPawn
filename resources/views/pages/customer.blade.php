                            ...
                            <tbody>
                                @foreach ($customers as $row)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($row->is_active)
                                            <button data-url="{{ route('customer.status-change') }}"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="customer_first_name" name="customer_first_name"
                                            placeholder="Enter the  Name" value="{{ old('customer_first_name') }}" required/>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="customer_sur_name" name="customer_sur_name"
                                            placeholder="Enter the Sur Name" value="{{ old('customer_sur_name') }}" required/>
