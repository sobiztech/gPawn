                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-10p border-bottom-0">Emp No</th>
                                    <th class="wd-15p border-bottom-0">First Name</th>
                                    <th class="wd-15p border-bottom-0">Sur Name</th>
                                    ...
                                    <th class="wd-10p border-bottom-0">Contract Start Date</th>
                                    <th class="wd-10p border-bottom-0">Contract End Date</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-blue edit" title="Edit" data-id="{{ $row->id }}"
                                                ...
                                                data-role_id="{{ $row->role_id }}" data-nic="{{ $row->nic }}"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="employee_first_name"
                                            name="employee_first_name" placeholder="Enter the  First Name"
                                            value="{{ old('employee_first_name') }}" required />
                                        <p style="color:Tomato"> @error('employee_first_name')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="employee_sur_name"
                                            name="employee_sur_name" placeholder="Enter the Sur Name"
                                            value="{{ old('employee_sur_name') }}" required />
                                        <p style="color:Tomato"> @error('employee_sur_name')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
                                        ...
                                        <select class="form-select" required name="property_id" id="property_id">
                                            ...
                                            @foreach ($properties as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('property_id') == $item->id ? 'selected' : '' }}>
                                                    {{ $item->property_name }}</option>
                                            @endforeach
                                        </select>
                                        <p style="color:Tomato"> @error('property_id')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        <select class="form-select" required name="department_id" id="department_id">
                                            ...
                                            @foreach ($departments as $item)
                                                <option class="departments department_{{ $item->id }}"
                                                    value="{{ $item->id }}"
                                                    {{ old('department_id') == $item->id ? 'selected' : '' }}>
                                                    {{ $item->department_name }}</option>
                                            @endforeach
                                        </select>
                                        <p style="color:Tomato"> @error('department_id')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <p style="color:Tomato"> @error('role_id')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <p style="color:Tomato"> @error('nic')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="date" class="form-control" id="date_of_birth"
                                            ...
                                            max="{{ date('Y-m-d') }}" />
                                        <p style="color:Tomato"> @error('date_of_birth')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <p style="color:Tomato"> @error('gender')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <p style="color:Tomato"> @error('phone_number')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <p style="color:Tomato"> @error('address')
                                            {{ $message }}
                                        @enderror
                                    </p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="date" class="form-control" id="contract_start_date"
                                            ...
                                            max="{{ date('Y-m-d') }}" />
                                        <p style="color:Tomato"> @error('contract_start_date')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="date" class="form-control" id="contract_end_date"
                                            ...
                                            min="{{ date('Y-m-d') }}" />
                                        <p style="color:Tomato"> @error('contract_end_date')
                                                {{ $message }}
                                            @enderror
                                        </p>
                                    </div>
