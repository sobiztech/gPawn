                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="{{ route('customer.index') }}" class="slide-item">Customres</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">Loan</a></li>
                                    <li><a href="{{ route('loan.index') }}" class="slide-item">Loans</a></li>
                                    {{-- <li><a href="{{url('datatable')}}" class="slide-item">Data Tables</a></li>
                                    <li><a href="{{url('table-editable')}}" class="slide-item">Editable Tables</a></li> --}}
                                </ul>
                            </li>
                            ...
                            {{-- <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Main Menu</span><i class="angle fa fa-angle-right"></i>
                                </a>
                                <ul class="slide-menu">
