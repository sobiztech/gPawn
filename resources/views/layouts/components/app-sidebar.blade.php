            ...
            <div class="sticky">
                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('index.dashboard') }}">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="{{ route('property.index') }}" class="slide-item">Property</a></li>
                                    <li><a href="{{ route('department.index') }}" class="slide-item">Department</a></li>
                                    <li><a href="{{ route('role.index') }}" class="slide-item">Role</a></li>
                                    <li><a href="{{ route('employee.index') }}" class="slide-item">Employee</a></li>
                                    {{-- <li><a href="{{ route('user.index') }}" class="slide-item">User</a>
                            </li> --}}
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Customer</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <!-- <li class="side-menu-label1"><a href="javascript:void(0)">Customer</a></li> -->
                                <li><a href="{{ route('customertype.index') }}" class="slide-item">Customer Type</a></li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Loan</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <!-- <li class="side-menu-label1"><a href="javascript:void(0)">Customer</a></li> -->
                                <li><a href="{{ route('loantype.index') }}" class="slide-item">Loan Type</a></li>
                                <li><a href="{{ route('loan.index') }}" class="slide-item">Loan</a></li>
                                <li><a href="{{ route('loandetail.index') }}" class="slide-item">Loan Details</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Levy</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <!-- <li class="side-menu-label1"><a href="javascript:void(0)">Customer</a></li> -->
                                <li><a href="{{ route('paymenttype.index') }}" class="slide-item">Payment Types</a></li>
                                <li><a href="{{ route('payment.payable') }}" class="slide-item">Payables</a></li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Black Lists</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <!-- <li class="side-menu-label1"><a href="javascript:void(0)">Customer</a></li> -->
                                <li><a href="{{ route('blacklisttype.index') }}" class="slide-item">Black List Types</a></li>
                                <li><a href="{{ route('blacklist.index') }}" class="slide-item">Black List</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="#" class="slide-item">Customer Detail</a></li>
                                <li class="sub-slide">
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Submenu-2</span><i class="sub-angle fa fa-angle-right"></i></a>
                                    <ul class="sub-slide-menu">
                                        <li><a class="sub-slide-item" href="#">Submenu-2.1</a></li>
                                        <li><a class="sub-slide-item" href="#">Submenu-2.2</a></li>
                                        <li class="sub-slide2">
                                            <a class="sub-side-menu__item2" href="#" data-bs-toggle="sub-slide2"><span class="sub-side-menu__label2">Submenu-2.3</span><i class="sub-angle2 fa fa-angle-right"></i></a>
